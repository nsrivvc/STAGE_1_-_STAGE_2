...
BUSINESS_COLUMNS: Dict[str, List[tuple]] = {
    ...
    "gawd_loc": [
        ("GS_ID", "int"), ("Id", "varchar"), ("OfferNumber", "varchar"),
        ("BidNumber", "varchar"), ("AwardNumber", "varchar"),
        ("TransportationServiceProviderPropCode", "varchar"),
        ("IBRRateFloor", "varchar"), ("IBRNameVolume", "varchar"),
        ("MaximumVolumetricCommitmentQuantity", "int"),
        ("SeasonalStartDate", "datetime"), ("SeasonalEndDate", "datetime"),
        ("LocationPurposeCode", "varchar"), ("StdLocPropPurposeCode", "varchar"),
        ("LocationPurposeCodeValue", "varchar"), ("LocationName", "varchar"),
        ("LocationPropCode", "varchar"), ("LocationQuantityTypeIndicator", "varchar"),
        ("LocationQuantityTypeIndicatorCodeValue", "varchar"),
        ("CapacityTypeLocationIndicator", "varchar"),
        ("CapacityTypeLocationIndicatorCodeValue", "varchar"), ("Route", "varchar"),
        ("AwardQuantityLocation", "varchar"), ("SeasonalDateFormat", "varchar"),
        ("BidderDuns", "int"), ("ReleaserDuns", "int"), ("CreatedDate", "datetime"),
        ("Version_Status", "varchar"), ("UpdatedDateTime", "datetime"),
    ],
    "gawd_rates": [
        ("GS_ID", "int"), ("Id", "varchar"), ("OfferNumber", "varchar"),
        ("BidNumber", "varchar"), ("AwardNumber", "varchar"), ("BidderDuns", "int"),
        ("ReleaserDuns", "int"), ("TransportationServiceProviderPropCode", "varchar"),
        ("LocationPurpose", "varchar"), ("LocationPurposeCodeValue", "varchar"),
        ("LocationName", "varchar"), ("LocationPropCode", "varchar"),
        ("IdentificationCodeQualifier", "varchar"), ("ReservationRateBasis", "varchar"),
        ("MarketBasedRateIndicator", "varchar"),
        ("SurchargeIndicatorCodeValue", "varchar"), ("SurchargeIndicator", "varchar"),
        ("ChargeInformationReferenceNumber", "varchar"), ("ChargeCode", "varchar"),
        ("ChargeRate", "varchar"), ("AwardRate", "varchar"),
        ("AwardRateIdentificationCode", "varchar"), ("MaximumTariffRate", "varchar"),
        ("MaximumTariffRateIdentificationCode", "varchar"),
        ("AwardPercentageOfMaximumTariffRate", "varchar"),
        ("AwardPercentageOfMaximumTariffRateIdentificationCode", "varchar"),
        ("MinimumVolumetricCommitmentPercentage", "varchar"),
        ("IBRAllowableDifferential", "varchar"),
        ("IBRAllowableDifferentialRateFloor", "varchar"),
        ("IBRBidValuePercent", "varchar"), ("CreatedDate", "datetime"),
        ("Version_Status", "varchar"), ("UpdatedDateTime", "datetime"),
    ],
    "gtran_it_rates": [
